...
class Game {
    ...
    private boolean processCommand(String line) {
        ...
        if (command.matches()) {
            ...
            case "set":
                set(command.group(2).toLowerCase(),
    ...
    /** Sets PLAYER playing to false and processes LINE. */
    private void set(String line, String player) {
        _playing = false;
        _board.set(_board.col(line), _board.row(line),
            Piece.playerValueOf(player));
    }
    /** Clears the board. */
    private void clear() {
        _playing = false;
